...
class Noise extends Component {
	...
	handlePLay1 = async () => {
		...
		this.setState({ playing1: true});
	  	const soundObject = new Expo.Audio.Sound();
	  		try {
	    		await soundObject.loadAsync(require('../sounds/drums/kick3.wav'));
	...
	handlePLay2 = async () => {
		...
		this.setState({ playing2: true});
	  	const soundObject = new Expo.Audio.Sound();
	  		try {
	    		await soundObject.loadAsync(require('../sounds/drums/snhit.wav'));
	    	{ shouldPlay: true }
	    	this.audioPlayer2  = soundObject;
	    		 ...
	    		 this.audioPlayer2.setVolumeAsync(0.6);
	...
	handlePLay3 = async () => {
		...
		this.setState({ playing3: true});
	  	const soundObject = new Expo.Audio.Sound();
	  		try {
	    		await soundObject.loadAsync(require('../sounds/drums/h1.wav'));
	    	{ shouldPlay: true }
	    	this.audioPlayer3  = soundObject;
	    		 ...
	    		 this.audioPlayer3.setVolumeAsync(0.4);
	...
	handlePLay4 = async () => {
		...
		this.setState({ playing4: true});
	  	const soundObject = new Expo.Audio.Sound();
	  		try {
	    		await soundObject.loadAsync(require('../sounds/drums/hh.wav'));
	    	{ shouldPlay: true }
	...
	handlePLay5 = async () => {
		...
		this.setState({ playing5: true});
	  	const soundObject = new Expo.Audio.Sound();
	  		try {
	    		await soundObject.loadAsync(require('../sounds/drums/claps.wav'));
	    	{ shouldPlay: true }
	    	this.audioPlayer5  = soundObject;
	    		...
	    		this.audioPlayer5.setVolumeAsync(0.2);
	...
	handlePLay6 = async () => {
		...
		this.setState({ playing6: true});
	  	const soundObject = new Expo.Audio.Sound();
	  		try {
	    		await soundObject.loadAsync(require('../sounds/drums/tdrums.wav'));
	    	{ shouldPlay: true }
	...
	renderButton6 () {
	 ...
	 async _cacheResourcesAsync() {
	     const samples = [
	       require('../sounds/drums/kick3.wav'),
	       require('../sounds/drums/snhit.wav'),
	       require('../sounds/drums/h1.wav'),
	       require('../sounds/drums/hh.wav'),
	       require('../sounds/drums/claps.wav'),
	       require('../sounds/drums/tdrums.wav'),
	     ];
