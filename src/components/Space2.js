...
class Space2 extends Component {
	...
	handlePLay1 = async () => {
		...
		this.setState({ playing1: true});
	  	const soundObject = new Expo.Audio.Sound();
	  		try {
	    		await soundObject.loadAsync(require('../sounds/textures/t1.wav'));
	    	{ shouldPlay: true }
	...
	handlePLay2 = async () => {
		...
		this.setState({ playing2: true});
	  	const soundObject = new Expo.Audio.Sound();
	  		try {
	    		await soundObject.loadAsync(require('../sounds/textures/t2.wav'));
	    	{ shouldPlay: true }
	    	this.audioPlayer2  = soundObject;
	    		...
	    		this.audioPlayer2.setVolumeAsync(0.4);
	...
	handlePLay3 = async () => {
		...
		this.setState({ playing3: true});
	  	const soundObject = new Expo.Audio.Sound();
	  		try {
	    		await soundObject.loadAsync(require('../sounds/textures/t3.wav'));
	    	{ shouldPlay: true }
	    	this.audioPlayer3  = soundObject;
	    		...
	    		this.audioPlayer3.setVolumeAsync(0.3);	
	...
	handlePLay4 = async () => {
		...
		this.setState({ playing4: true});
	  	const soundObject = new Expo.Audio.Sound();
	  		try {
	    		await soundObject.loadAsync(require('../sounds/textures/t4.wav'));
	    	{ shouldPlay: true }
	    	this.audioPlayer4  = soundObject;
	    		...
	    		this.audioPlayer4.setVolumeAsync(0.6);
	...
	handlePLay5 = async () => {
		...
		this.setState({ playing5: true});
	  	const soundObject = new Expo.Audio.Sound();
	  		try {
	    		await soundObject.loadAsync(require('../sounds/textures/t5.wav'));
	    	{ shouldPlay: true }
	    	this.audioPlayer5  = soundObject;
	    		...
	    		this.audioPlayer5.setVolumeAsync(0.7);
	...
	handlePLay6 = async () => {
		...
		this.setState({ playing6: true});
	  	const soundObject = new Expo.Audio.Sound();
	  		try {
	    		await soundObject.loadAsync(require('../sounds/textures/t6.wav'));
	    	{ shouldPlay: true }
	    	this.audioPlayer6  = soundObject;
	    		...
	    		this.audioPlayer6.setVolumeAsync(0.1);
	...
	renderButton6 () {
	 ...
	 async _cacheResourcesAsync() {
	     const samples = [
	       require('../sounds/textures/t1.wav'),
	       require('../sounds/textures/t2.wav'),
	       require('../sounds/textures/t3.wav'),
	       require('../sounds/textures/t4.wav'),
	       require('../sounds/textures/t5.wav'),
	       require('../sounds/textures/t6.wav'),
	     ];
